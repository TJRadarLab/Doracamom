...
use_pos = True
point_cloud_range = [0, -39.68, -3, 69.12, 39.68, 2.76] #---自车/lidar坐标系后面改成60,40
...
model = dict(
    ...
    pts_middle_encoder=dict(
        type='PointPillarsScatter', in_channels=64, output_shape=[496, 432]), #---这里修改成440,560。y,x/voxelsize
...
dataset_type = 'KittiDataset_tj4d'
...
total_epochs = 16 #---默认24
checkpoint_config = dict(interval=1, max_keep_ckpts=10)

runner = dict(type='EpochBasedRunner', max_epochs=total_epochs)
dist_params = dict(backend='nccl')
log_level = 'INFO'
work_dir = 'work_dirs/Doracamom_TJ4D/doracamom_TJ4D_1203'
load_img_from_and_not_change_state_dict = 'ckpts/r50_fcos3d_pretrain.pth'
load_pts_from = '/mnt/zhenglianqing/4-dradar_mmdet3d4/work_dirs/TJ4D_4DRadar_RadarPillarFeatureNet_11.11_final/epoch_80.pth'
resume_from = None
load_from=None
workflow = [('train', 1)]
