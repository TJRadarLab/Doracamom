...
model = dict(
    ...
    out_indices=(1,2,3),
    frozen_stages=1,
    norm_cfg=dict(type='BN', requires_grad=False), #----这里更改一下
    norm_eval=True, #—----训练模式
    style='pytorch'),
...
log_level = 'INFO'
work_dir = 'work_dirs/NewScenes_Final/bevf_newscenesfinal_fusion'

load_lift_from = 'work_dirs/NewScenes_Final/bevf_LSS_depth_newscenesfinal_cam_bevpoolv2/epoch_24.pth'
resume_from = None
