...
log_level = 'INFO'
work_dir = 'work_dirs/NewScenes_Final/bevf_LSS_depth_newscenesfinal_cam_bevpoolv2_syncBN'

load_img_from_and_not_change_state_dict = 'ckpts/r50_fcos3d_pretrain.pth'

resume_from = '/mnt/zhenglianqing/bevformer_noted/work_dirs/NewScenes_Final/bevf_LSS_depth_newscenesfinal_cam_bevpoolv2_syncBN/epoch_4.pth'
load_from = None
workflow = [('train', 1)]
