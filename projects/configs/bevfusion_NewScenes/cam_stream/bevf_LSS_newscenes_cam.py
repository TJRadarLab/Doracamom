...
log_level = 'INFO'
work_dir = 'work_dirs/NewScenes_Final/bevf_LSS_newscenesfinal_cam_BEVPOOLv2'

load_img_from_and_not_change_state_dict = 'ckpts/r50_fcos3d_pretrain.pth'

resume_from = '/mnt/zhenglianqing/bevformer_noted/work_dirs/NewScenes_Final/bevf_LSS_newscenesfinal_cam_BEVPOOLv2/epoch_2.pth'
load_from = None
workflow = [('train', 1)]
