...
class RCDetSOCTransformer_vod_anchorhead(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(RCDetSOCTransformer_vod_anchorhead, self).__init__(**kwargs)
...
#                   'prev_bev_radar':torch.Size([1, 2, 384, 160, 240])}
    ...
    def forward(self,
        ...
        if self.use_temporal_encoder:
            ...
            bev_img_embed = bev_img_feat
            bev_radar_feat = pts_feats[0]
        ...
        #-----输出#--torch.Size([1, 256, 160, 240])------
            ...
            if self.with_occ:
                return bev_img_feat, occupancy, voxel_det, bev_seg_feat
            return bev_img_feat,voxel_det, bev_embed_det, bev_seg_feat
