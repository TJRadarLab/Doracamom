...
class RCDetSOCTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(RCDetSOCTransformer, self).__init__(**kwargs)
    ...
    def init_weights(self):
        ...
        for m in self.modules():
            if isinstance(m, MSDeformableAttention3DV1) or isinstance(m, TemporalSelfAttention) \
                    or isinstance(m, CustomMSDeformableAttention) or isinstance(m, DeformSelfAttention3DCustom):
                try:
                    m.init_weight()
