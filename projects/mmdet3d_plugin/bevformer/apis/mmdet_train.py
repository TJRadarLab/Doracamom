...
from projects.mmdet3d_plugin.core.evaluation.eval_hooks import CustomDistEvalHook,CustomDistEvalHook_old
...
def custom_train_detector(model,
    ...
    #---------------调用自己写的build_dataloader，在plugin/datasets/bulider里--------
    #---------------主要控制shuffle与非shuffle,默认shuffle是True-----------------
    data_loaders = [
        build_dataloader(
            ds,
