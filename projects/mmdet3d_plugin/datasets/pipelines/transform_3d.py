...
class PadMultiViewImage(object):
    ...
    def __call__(self, results):
        ...
        #     cv2.imwrite(f'/mnt/zhenglianqing/bevformer_noted/debug_some_imgresult/draw_box_debug/gt_bbox_to_img_resize_pad{i}.jpg', img)
        # #----------------------------
        return results
...
class CustomCollect3D(object):
    ...
    def __init__(self,
                 keys,
                 meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img','lidar2cam','ego2lidar',
                            ...
                            'can_bus','pc_range', 'occ_size', 'occ_path', 'lidar_token',"ego2global_transformation", "lidar2ego_transformation",
                            )):
        self.keys = keys
...
class RandomScaleImageMultiViewImage(object):
    ...
    def __init__(self, scales=[],scale_lidar2img=True):
        self.scales = scales
        self.scale_lidar2img = scale_lidar2img
