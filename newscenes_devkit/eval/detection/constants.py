...
# DETECTION_NAMES = ['car', 'truck', 'trailer', 'bus', 'engineering_vehicle',
#                'rider', 'pedestrian',"tricyclist", "light_truck"] #--后面再改

DETECTION_NAMES = ['car', 'pedestrian', 'rider', 'large_vehicle'] #--后面再改
