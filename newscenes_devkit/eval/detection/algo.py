...
from newscenes_devkit.eval.common.utils import center_distance, scale_iou, yaw_diff, velocity_l2, attr_acc, cummean
from newscenes_devkit.eval.detection.data_classes import DetectionMetricData
...
def accumulate(gt_boxes: EvalBoxes,
    ...
    # ---------------------------------------------
    #-----set不能有重复的，每个预测都找最近的，每个GT也最多只能匹配一个预测-----------
    ...
    # Accumulate.
    #---------计算逐步的累积和，返回和原来一样大小的数组，这个是用来根据置信度大小的顺序，计算前n个目标，n从1到全部预测框，绘制pr曲线----
