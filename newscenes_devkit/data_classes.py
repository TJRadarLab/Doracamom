...
class Box:
    ...
    def __init__(self,
        ...
        self.name = name
        self.track_id = int(track_id) if not np.isnan(track_id) else track_id
    ...
    def __repr__(self):
        repr_str = 'label: {}, score: {:.2f}, xyz: [{:.2f}, {:.2f}, {:.2f}], wlh: [{:.2f}, {:.2f}, {:.2f}], ' \
                   ...
                   'vel: {:.2f}, {:.2f}, {:.2f}, visibility:{}, name: {}, track_id: {}'
        ...
        return repr_str.format(self.label, self.score, self.center[0], self.center[1], self.center[2], self.wlh[0],
                               ...
                               self.velocity[0], self.velocity[1], self.velocity[2],self.visibility, self.name, self.track_id)
